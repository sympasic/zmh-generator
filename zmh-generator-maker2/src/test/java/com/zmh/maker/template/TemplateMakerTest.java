...
import com.zmh.maker.template.model.TemplateMakerConfig;
...
public class TemplateMakerTest {
    ...
    public void testMakeTemplateBug1() {
        ...
        String originProjectPath = new File(projectPath).getParent() + File.separator + "zmh-generator-demo-projects/springboot-init-master";
